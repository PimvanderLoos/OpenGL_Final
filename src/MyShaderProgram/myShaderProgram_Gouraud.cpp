#include "myShaderProgram_Gouraud.h"

void MyShaderProgram_Gouraud::init()
{
...
MyShaderProgram_Gouraud::MyShaderProgram_Gouraud(QOpenGLFunctions_3_3_Core *const gl,
...
void MyShaderProgram_Gouraud::paint(RenderData &renderData)
{
