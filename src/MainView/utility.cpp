...
size_t MainView::getFPS() const
{
    return d_fps;
}

float MainView::getMaxFrameTime() const
{
    return d_maxFrameTime;
}

float MainView::getAvgFrameTime() const
{
    return d_avgFrameTime;
}

float MainView::getDefaultScale() const
{
    return d_defaultScale;
}
